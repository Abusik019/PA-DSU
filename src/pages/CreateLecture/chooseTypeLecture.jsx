    ...
    return (
        <div className="w-full h-full flex flex-col justify-start gap-[40px] items-center pt-[100px] box-border relative">
            ...
            <div className="w-full flex justify-between items-center">
                <h1 className="text-5xl max-sm:text-3xl max-sm:text-center">Выберите способ создания лекции</h1>
            </div>
            <div
                style={{ height: "calc(100% - 164px)" }}
                className="w-full overflow-y-auto flex items-center justify-center gap-[30px] max-sm:flex-col"
            >
                <div 
